...
@section('content')
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text">Tổng số sản phẩm</div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card">
                        <div class="stat-widget-two card-body">
                            <div class="stat-content">
                                <div class="stat-text">Tổng số lượt xem</div>
                                <div class="stat-digit"> {{ $statistics['total_views'] }}</div>
                            </div>
                            <div class="progress">
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Nguyen Quang Thuong</a>
                2024</p>
